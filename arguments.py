...
class Arguments:
    ...
    def add_common_args(self):
        ...
        self._parser.add_argument('--data_path', type=str,
                                  default='../../Pointnet_Pointnet2_pytorch/data/modelnet40_normal_resampled/')
        self._parser.add_argument('--input_point_nums', type=int, default=1024, help='Point nums of each point cloud')
        self._parser.add_argument('--normal', action='store_true', default=False,
                                  help='Whether to use normal information [default: False]')
        self._parser.add_argument('--num_workers', type=int, default=4, help='Worker nums of data loading.')

        ### network related
        self._parser.add_argument('--defended_model', type=str, default='pointnet_cls',
                                  choices=['pointnet_cls', 'pointnet2_cls_msg', 'dgcnn', 'curvenet'])
        ...
        self._parser.add_argument('--DEGREE', type=int, default=[1, 2, 2, 2, 2, 2, 64], nargs='+',
                                  help='Upsample degrees for generator.')
        self._parser.add_argument('--D_FEAT', type=int, default=[3, 64, 128, 256, 256, 512], nargs='+',
                                  help='Features for discriminator.')
        self._parser.add_argument('--G_FEAT', type=int, default=[96, 256, 256, 256, 128, 128, 128, 3], nargs='+',
        ...
        self._parser.add_argument('--use_multi_gpu', action='store_true', default=False,
                                  help='Whether to use more than 1 gpu [default: False]')
    ...
    def add_train_args(self):
        ...
        self._parser.add_argument('--lr_c', default=0.001, type=float,
                                  help='learning rate for classifier in training [default: 0.001]')
        self._parser.add_argument('--lr_ng', default=0.001, type=float,
                                  help='learning rate for noise-generator in training [default: 0.001]')
        self._parser.add_argument('--lr_fp', default=0.001, type=float,
                                  help='learning rate for prototype searching [default: 0.001]')
        ...
        self._parser.add_argument('--temperature_cent', type=float, default=0.25,
                                  help='the temperature of centralizing loss')
        self._parser.add_argument('--temperature_adv', type=float, default=0.1,
                                  help='the temperature of adversarial loss')
        ...
        self._parser.add_argument('--init_search_iters', type=int, default=500,
                                  help='initial num of iterations for prototype searching.')
        self._parser.add_argument('--update_search_iters', type=int, default=10,
                                  help='per-step num of iterations for prototype searching.')
        self._parser.add_argument('--multi_attack', action='store_true', default=False,
                                  help='Use multiple attacks during training')
        self._parser.add_argument('--attack_mix_mode', type=str, default='random',
                                  choices=['random', 'all'],
        ...
        self._parser.add_argument('--cls_adv_weight', type=float, default=1.0,
                                  help='weight for CE loss on adversarial examples')
        self._parser.add_argument('--pgd_train_iter', type=int, default=3,
                                  help='iteration number for pgd training attack')
        self._parser.add_argument('--jitter_sigma', type=float, default=0.01)
        self._parser.add_argument('--jitter_clip', type=float, default=0.02)
        self._parser.add_argument('--drop_num', type=int, default=128)
        self._parser.add_argument('--curriculum_attack', action='store_true', default=False)
        ...
        self._parser.add_argument('--num_iter_cw', type=int, default=50, metavar='N',
                                  help='Number of iterations in each CW search step')

    def add_test_args(self):
        self._parser.add_argument('--mode', type=str, default='test_normal',
                                  choices=['test_normal', 'test_aa', 'test_ba'])
        ...
        self._parser.add_argument('--pre_defense', type=str, default='sor',
                                  choices=['sor', 'srs', 'dupnet', 'upsampling', 'denoising'])
        # for black-box attacks
        self._parser.add_argument('--source_model', type=str, default='pointnet_cls',
                                  choices=['pointnet_cls', 'pointnet2_cls_msg', 'dgcnn', 'curvenet'])
